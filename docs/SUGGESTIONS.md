...
| 54 | 2026-08-29 | Releases still outstanding for the hero footage | **OPEN, and it is now live rather than hypothetical.** Real identifiable people are on the homepage of a site that will carry advertising. The `release` field for all three panels in `hero.json` is still null. Confirm signed releases exist and record where they are filed. See [IMAGERY.md](IMAGERY.md). |
